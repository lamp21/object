      ...
      <ul id="starlist" style="font-size: 18px;">
        <li><a href="/home/index">首页</a></li>
          ...
          @if(isset(session('userinfo')->uname))
              <li><img src="{{ $value->uname_img ? $value->uname_img : '/img/1.jpeg'}}" style="width: 30px;height: auto;float: right;border-radius:50%; position: relative;top: 10px;"><a href="/home/about">{{ session('userinfo')->uname }}</a></li>
