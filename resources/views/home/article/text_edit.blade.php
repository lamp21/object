...
<article>
    ...
    <div>
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="art_title" placeholder="标题" name="art_title" value="{{$v->art_title}}">
	  </div>
	  <div class="form-group">
	  ...
	  <div class="form-group">
	    <label for="exampleInputFile">内容</label>
	  	<!-- 加载编辑器的容器 -->
	    <script id="container" name="art_content" type="text/plain" class="art_content">
      ...
      @endforeach
	  <button type="submit" class="btn btn-success" id="but">确认修改</button>
	</form>
    <script type="text/javascript">
  //非空验证
    $('#but').click(function () {
