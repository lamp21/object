...
<article> 
  ...
  <div class="lbox">
    <div class="content_box whitebg">
      <h2 class="htitle">
        <span class="con_nav">您现在的位置是：<a href="/home/index">网站首页</a>><a href="javascript:return false;">精彩文章</a></span>精彩文章
      </h2>
      @foreach($word as $k=>$v)
      <h1 class="con_tilte">{{$v->title}}</h1>
      <p class="bloginfo">
        <i class="avatar"><img src="/home_public/images/avatar.jpg"></i>
        <span><b style="color: black;">来源于:</b>{{$v->wd_form}}</span>
        <span>{{$v->wd_time}}</span>
    ...
    <div class="whitebg gbook">
      ...
      <ul>
        ...
        <div class="comment-text-area">
          @foreach($word as $k=>$v)
          <form action="/home/wdfmessage/{{$v->id}}" method="post">
            {{ csrf_field() }}
          <div>
        ...
        <div style="text-align:center;margin:50px 0; font:normal 14px/24px 'MicroSoft YaHei';">
          ...
          <div class="comment-wrap">
              ...
              <div class="comment-content-header">
                <span>
                  <p class="content" style="color:grey;"><b>消息</b></p>
                </span>
              </div>
              <i class="glyphicon glyphicon-time" style="color: blue;">时间</i>
              </div>  
          </div>
        </div>
