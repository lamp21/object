...
<body>
	<div class='login' style="height: 290px;">
	  ...
	  <div class='login_fields'>
	  	<form action="/home/index" method="post">
		    ...
		    <div class='login_fields__password'>
		      ...
		      <input name="upass" placeholder='密码' type='password'>
		      <div class='validation'>
		        <img alt="" src='/home_public/images/img/tick.png'>
		      </div>
		    </div>
	  ...
	  <div class='disclaimer'>
	    <p style="font-size: 18px;margin: 10px;float: left;">Homie action&nbsp;&nbsp;&nbsp;<a href="/home/index" style="color:lightblue;">首页</a>&nbsp;&nbsp;&nbsp;<a href="/home/register" style="color:lightblue;">注册</a></p>
	  </div>
	</div>
	<div class='authent'>
	    ...
	    layui.use('layer', function () {
	        $('input[type="submit"]').click(function () {
	            ...
	            if (phone == '') {
	                ...
	                //登录
	                var JsonData = { phone: phone, upass: upass, code: code };
					//此处做为ajax内部判断
					var url = "";
