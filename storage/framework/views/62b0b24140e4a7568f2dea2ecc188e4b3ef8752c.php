...
<div class="searchbox">
  <div class="search">
    <form action="" method="post" name="searchform" id="searchform">
      <input name="search" id="keyboard" class="input_text" value="<?php echo e(isset($request['search']) ? $request['search'] : ''); ?>" style="color: rgb(153, 153, 153);" onfocus="if(value=='请输入关键字词'){this.style.color='#000';value=''}" onblur="if(value==''){this.style.color='#999';value='请输入关键字词'}" type="text">
...
<article> 
  ...
  <div class="lbox">
    ...
    <div class="zhuanti whitebg">
      ...
      <li>
        ...
        <span id="sp" style="width: 300px !important;float: left !important;overflow: hidden !important;text-overflow: ellipsis !important;"abbr title="<?php echo $v->content; ?>">
              <?php echo $v->content; ?>

          </abbr>
        </span>
        <a href="/home/wonderful/<?php echo e($v->id); ?>" target="_blank" class="readmore">文章阅读</a >
      </li>
      <?php endif; ?>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
    ...
    <div class="whitebg bloglist">
      ...
      <ul> 
      <?php $__currentLoopData = $article_res; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if($v->display == 0): ?>
        <li>
      ...
      <?php else: ?>
        <li>
          <h3 class="blogtitle">
            <a href="/home/article/<?php echo e($v->id); ?>" target="_blank"><?php echo e($v->art_title); ?></a>
          </h3>
          <p class="blogtext">
            <?php echo $v->art_content; ?>

          </p>
          <p class="bloginfo">
           
            <i class="avatar"><img src="<?php echo e($value->uname_img); ?>"></i>
            <span><?php echo e($value->uname); ?></span>
            
            <span><?php echo e($v->art_time); ?></span>
            <span>【<a href="/">原创模板</a>】</span>
          </p>
          <a href="/home/article/<?php echo e($v->id); ?>" class="viewmore">阅读更多</a> </li>
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </ul>
    </div>
  ...
  <div class="rbox">
    ...
    <div class="whitebg notice">
      ...
      <ul>
        <?php $__currentLoopData = $data_announcement; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <li><a href="/home/index/<?php echo e($val->id); ?>"><?php echo e($val->announcement_title); ?></a></li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </ul>
    </div>
    <div class="whitebg paihang">
      ...
      <ul>
        <?php $__currentLoopData = $wonderful_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <li>
        <i class="ztpic">
          <a href=" >id}}" target="_blank">
        </i>
